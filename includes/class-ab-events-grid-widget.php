...
class Events_Grid_Widget extends Widget_Base {
    ...
    protected function register_controls(): void {
        ...
        $this->add_control('accent_color', ['label' => 'Akcentus szín', 'type' => Controls_Manager::COLOR, 'default' => '#1A6EA3', 'selectors' => ['{{WRAPPER}} .ab-events-grid-wrapper' => '--ab-grid-accent: {{VALUE}};']]);
        $this->add_control('cta_color', ['label' => 'CTA gomb szín', 'type' => Controls_Manager::COLOR, 'default' => '#1A6EA3', 'selectors' => ['{{WRAPPER}} .ab-card-cta' => 'color: {{VALUE}};']]);
        $this->add_control('location_color', ['label' => 'Helyszín szöveg szín', 'type' => Controls_Manager::COLOR, 'default' => '#1A6EA3', 'selectors' => ['{{WRAPPER}} .ab-card-loc' => 'color: {{VALUE}};']]);
        ...
        $this->add_control('title_color_hover', ['label' => 'Cím hover szín', 'type' => Controls_Manager::COLOR, 'default' => '#1A6EA3', 'selectors' => ['{{WRAPPER}} .ab-card-title a:hover' => 'color: {{VALUE}};']]);
